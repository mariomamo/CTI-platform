...
export default class MetamaskMobileWallet {
    ...
    constructor(defaultWalletOperations) {
        ...
        const wallet = new MetaMaskSDK({
            dappMetadata: {
                name: 'CTI', // The name of your dapp.
                url: "http://192.168.1.21:5173", // The URL of your website.
    ...
    connect = () => this.#provider.request({method:'eth_requestAccounts'})
